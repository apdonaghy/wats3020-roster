...
class Course {
    ...
    addStudent() {
        let name = prompt("Enter student full name:", "Ferris Bueller");
        let email = prompt("Enter student email: ", "fbueller@seattleu.edu");
    ...
    setTeacher() {
        let name = prompt("Enter full teacher name:", "Edward Rooney");
        let email = prompt("Enter teacher email", "eroonney@seattleu.edu");
